...
All software released by the Organization shall be released under permissive open-source licenses and developed to standards of engineering excellence, including automation, performance, and documentation. These are first-order concerns of the Organization alongside scientific rigor.
...
The Organization shall be composed of three bodies — the Developers, the Steering Committee, and the Director — together tasked with carrying out the Mission, and an Operating Legal Entity that provides their legal and administrative framework:
...
The Steering Committee is the governing body of the Organization, tasked with setting strategic direction, raising and distributing the funds necessary to sustain the Organization, setting a budget, conducting oversight, and resolving internal disputes. The Steering Committee consists of Developers elected by the Developers, along with the Director, who serves as a voting member. The role and governance of the Steering Committee is further specified in Article 4.
...
The Organization shall be a constituent project of an Operating Legal Entity that provides the legal and administrative framework necessary to conduct Organization business. The Operating Legal Entity serves as the entity of record for contracts, employment, and financial administration on behalf of the Organization, and retains whatever legal authorities and fiduciary obligations are imposed on it by law and by its own governing documents. The relationship between the Organization and the Operating Legal Entity is further specified in Article 9.
...
Developers are expected to be active participants in the business and technical life of the Organization by writing and reviewing code, producing technical materials, providing input and feedback to the Steering Committee, and supporting one another and the broader structural biology community.

### **3.2 Technical Authority**

The Developers retain primary responsibility for technical implementation, coding standards, review norms, release standards, and related technical judgments, except as otherwise provided in Committee-approved policies governing Organization-Funded Work.
...
The Developers may adopt written Resolutions on matters within their authority, including coding practices, review standards, testing requirements, documentation norms, tooling, communication, internal structure, community building, and related engineering or operational concerns.
...
Adopted Resolutions and their current status shall be maintained as Organization records by the Director.

### **3.4 Composition**

Membership in the group of Developers is intended to reflect active contributions to the Organization.
...
The Developers retain the right to dissolve the Organization and nullify this Charter.
...
It is explicitly recognized that the Organization may make resources available to the Developers to empower them to execute their role within the Organization. The Steering Committee may therefore allocate budget for software services, travel, compute, collaboration tools, and other material resources that Developers will be eligible to use.

To the extent it does not conflict with this Charter, the policies of the Operating Legal Entity, or applicable law, resources distributed by the Organization to the Developers shall be made in an equitable fashion. The Steering Committee shall be responsible for ensuring no prejudice is made with respect to distribution of resources and for arbitrating any relevant disputes.

## **ARTICLE 4. The Steering Committee**

### **4.1 Charge**

The Steering Committee is the governing body of the Organization, tasked with ensuring that the Organization carries out the Mission, remains financially viable, sustains and grows as needed to do so, and resolves major questions of priority, governance, and resource allocation.
...
The Steering Committee is responsible for raising and dispensing the funds and resources necessary to sustain the Organization.

The Steering Committee shall meet regularly at a self-determined frequency.

Service on the Steering Committee is unpaid, except that (i) the Organization may support reasonable Committee-related administrative or meeting expenses in a manner disclosed to all Organization participants, and (ii) an individual who is compensated for another role in the Organization, such as the Director or engineering staff, does not forfeit that compensation by serving on the Committee.
...
Set Strategic Goals for the Organization. The Committee shall integrate input from the Developers and the broader community to set the overall scientific and engineering direction of the Organization. No less than once a year, the Committee shall produce a clear document, in any format, detailing the Strategic Goals for the Organization.

Before adopting the Strategic Goals, the Committee shall circulate a draft to all Developers and provide a comment period of no less than fourteen (14) days, during which any Developer may submit written comments to the Committee. The Committee shall consider the comments received before adopting the Strategic Goals, but is not bound by them. A copy of the adopted document shall be made available to the other Organization participants.

**B. Fundraising, Budget, and Fiduciary Responsibility.**  

Raise funds from industry partners, grants, philanthropy, and other sources; develop and approve a clear, high-level budget; and distribute Organization funds so as to realize the Strategic Goals while ensuring the long-term financial health of the Organization.
...
Resolve conflicts of interest, disputes among Organization participants, and other governance matters using the powers vested in the Committee by this Charter.

**F. Charter Amendment, Separation, and Dissolution.**  

Approve amendments to this Charter, initiate or approve dissolution of the Organization, and act on separation matters as provided elsewhere in this Charter.
...
The Committee may adopt, amend, and repeal written policies to direct the work of the Organization on any matter within its authority, including but not limited to contributions and intellectual property, funding and sponsorship arrangements, and project approval. All Committee-approved policies must be consistent with this Charter; in the event of conflict, this Charter controls. All Committee-approved policies shall be made available to the Developers.
...
**B.** supervise Organization-Funded Projects and Organization personnel;

**C.** recommend hiring, contracting, project initiation, and budget adjustments to the Committee;

**D.** support users, collaborators, and funders of the Organization in understanding, using, deploying, and maintaining Organization code and related outputs, consistent with Committee-approved policies and the Strategic Goals;

**E.** recommend that requests, support needs, or feature proposals originating from Developers or other participants be elevated to the Committee for consideration as Organization-Funded Projects or budget items;
...
No less than once per calendar year, the Steering Committee shall convene an Annual Meeting of the Organization, open to all Developers.
...
The Annual Meeting must be held in a virtual or hybrid (in-person and virtual) format, providing the possibility to participate for Organization participants around the world.

## **ARTICLE 7. Organization-Funded Work, Open Release, and Publication**

### **7.1 Definitions**

For purposes of this Charter:

**A. Organization-Funded Work** means software, documentation, datasets, benchmarks, infrastructure, or related outputs materially supported through funds, personnel, or resources administered by the Organization or the Operating Legal Entity.

**B. Organization-Funded Project** means an organized effort, initiative, or workstream approved by the Steering Committee for material support by the Organization, whether through funding, personnel, or other administered resources.

**C. External Work** means work contributed independently outside Organization support, including work created by Developers, contributors, collaborators, funders, or other participants acting outside such support.

**D. Release** means making Organization-Funded Work generally available to the public without access restriction, whether through publication of a source code repository, distribution of packaged or compiled artifacts, or equivalent means. Pre-release access provided to funders or other participants under Committee-approved policy does not constitute Release.

Except as otherwise provided in this Charter or in agreed project-specific terms, the Organization does not claim governance authority over purely External Work contributed outside Organization support.

### **7.2 Open Release Principle**

Software conceived or first actually reduced to practice as Organization-Funded Work shall be released under an Open Source Initiative approved permissive license with commercial terms no more restrictive than Apache 2.0, unless the Steering Committee approves another permissive license materially consistent with the Mission.

Data, documentation, and related non-software outputs generated as Organization-Funded Work may be shared under an appropriate permissive public license as determined by the Steering Committee.

### **7.3 Project Status and Adoption Policy**

The Organization shall maintain a Project Adoption Policy that defines the categories of project status the Organization recognizes, the criteria a project must meet to attain or retain each status, and the path by which a project may seek that status.
...
While public release of completed projects is the ultimate aim of the Organization, Organization-Funded Work may be held in private repositories for a period prior to public release. The intent of such limited private development is to:

**A.** protect the ability of Organization researchers to publish their findings without being scooped;  
...
**ii.** the Steering Committee determines that it is in the vital interests of the Organization,

the Committee may, by majority vote, compel either release or non-release of Organization-Funded Work.
...
The right of any Organization participant to own, publish, or otherwise pursue their own work, activities, and research directions, and any rights of ownership or freedom of any Organization participant who is not a contractual employee or contractor of the Organization or the Operating Legal Entity, shall not be restricted or abridged in any way by participation in the Organization.
...
Legal title to the intellectual property comprising Organization-Funded Work vests in the Operating Legal Entity, which holds it in trust for the charitable purposes of the Organization and the advancement of the Mission, consistent with any sponsorship or hosting agreement then in effect. This custodial ownership does not diminish the Open Release Principle of Section 7.2: Organization-Funded Work that has been Released remains available to the public under its Open Source Initiative approved license, which the Operating Legal Entity shall not revoke.

Contributions to Organization-Funded Work by participants who are not employees or contractors of the Organization or the Operating Legal Entity are licensed to the Operating Legal Entity under the applicable Open Source Initiative approved license rather than assigned, and such participants retain ownership of their contributions as provided in Section 7.5. Intellectual property developed independently of Organization support is External Work and remains the property of its creators.

Organization personnel are responsible for ensuring that the Operating Legal Entity obtains the licenses or permissions necessary to use any third-party intellectual property employed in Organization activities.
...
This policy applies to all Steering Committee members, the Director, and any Developer participating in a decision or vote on behalf of the Organization.
...
The Organization shall be a constituent project of an Operating Legal Entity that provides the legal and administrative framework for matters, financial or otherwise, pertaining to the Organization.

While RSS is a constituent project of the Operating Legal Entity, the following shall apply:

**A.** the Operating Legal Entity shall provide administrative and financial management for the Organization;  

**B.** the Operating Legal Entity shall be the legal entity of record in contractual agreements entered into on behalf of the Organization;  
...
**F.** the relationship between the Operating Legal Entity and the Organization shall be specified in a sponsorship or hosting agreement that further details the obligations of the Organization to the Operating Legal Entity and _vice versa_. The Operating Legal Entity holds the funds raised for the Organization; the Steering Committee's authority to direct their use is exercised within the available balance and otherwise subject to that agreement.
...
**C.** any hosted-project, fiscal sponsorship, grant, or contractual arrangements binding on the Organization;  

**D.** this Charter;  

**E.** Steering Committee-approved policies and procedures;  

**F.** other Organization practices or informal understandings.
...
Should no qualifying successor be secured within that period and any agreed extension, remaining Organization assets and liabilities shall be disposed of as provided in that agreement and applicable law, and the Organization shall enter dissolution under Section 10.2.

### **10.2 Dissolution**

Dissolution of the Organization may be initiated in one of the following ways:
...
Upon a valid dissolution trigger, the Steering Committee shall notify all Developers, funders, and any other parties with contractual relationships with the Organization within ten (10) calendar days.

The Organization shall continue operations in a wind-down capacity for no more than ninety (90) calendar days, during which:
...
On behalf of the funded Organization, the Operating Legal Entity shall keep complete books and records of account and minutes of the proceedings of the Steering Committee, together with such other records as are required by law, policy, or good governance.

The Organization shall maintain a public or participant-accessible record of current Steering Committee members, current Developers, the current version of this Charter, and a version history of prior Charter amendments.
...
All prior versions of the Charter shall be made available to any Developer upon request. A version history shall be maintained as a Organization record.
...
We, the undersigned, constitute the initial Developers of the Organization. We consent to and hereby adopt this Charter of the Reciprocal Space Station:
